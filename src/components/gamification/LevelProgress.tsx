  ...
  if (minimal) {
    return (
      <div className="flex items-center gap-1.5">
        <motion.div
          className="bg-[#ebbd34] rounded-full w-4 h-4 flex items-center justify-center text-white text-xs font-bold"
        ...
        <Progress value={progressPercentage} className="w-12 h-1.5 bg-[#ebbd34]/20" />
      </div>
    );
  }
    ...
    <div className="flex flex-col">
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center">
          <motion.div
            className="bg-[#ebbd34] rounded-full w-5 h-5 flex items-center justify-center text-white text-xs font-bold mr-2"
            whileHover={{ scale: 1.1 }}
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.2 }}
        ...
        <div className="flex items-center">
          <Sparkles className="h-3.5 w-3.5 text-[#ebbd34] mr-1" />
          <span className="text-xs font-medium text-[#ebbd34]">{profile.points}</span>
        </div>
      </div>
      <div className="flex items-center gap-2">
        <Progress 
          value={progressPercentage} 
          className="h-1.5 bg-[#ebbd34]/20 flex-1" 
        />
